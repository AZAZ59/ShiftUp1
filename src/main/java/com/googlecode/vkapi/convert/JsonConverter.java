...
public class JsonConverter {
    ...
    public JsonConverter() {
        java.util.logging.Logger.getLogger(JsonConverter.class.getName()).setLevel(Level.INFO);
    }
    ...
    public List<VkUser> jsonToUserList(String json) {
        ...
        while (elements.hasNext()) {
            ...
            if(added.contains(user.getFirstName()+" "+user.getLastName())){
                user.setLastName(user.getLastName()+"__");
            }
            added.add(user.getFirstName()+" "+user.getLastName());
